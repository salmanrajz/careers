...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://magicjar.github.io/whatsapp-widget/dist/css/whatsapp-widget.min.css" rel="stylesheet">
        <!-- Styles -->
        <style>
    ...
    <!-- End -->
     <!-- Built in form -->
    <form id="general-support" class="wa-widget" action="923121337222" data-chat="general-support"></form>
    <!-- End -->
    ...
    {{-- <img src="https://cdn.iconscout.com/icon/free/png-512/whatsapp-circle-1868968-1583132.png" class="" style="margin-left: -15px;height: 30px;"> --}}
    <script src="https://magicjar.github.io/whatsapp-widget/dist/js/whatsapp-widget.min.js"></script>

    <script>
        var generalSupport = new WhatsAppWidget(document.getElementById('general-support'), {
            name: 'Fajar Setya',
            division: 'General Supports',
            photo: 'https://magicjar.github.io/whatsapp-widget/images/user.png',
